...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#000"),
    ...
    startAnimationTime: kvLookup('startAnimationTime', config, dataset, 1000),
    ...
    refreshAnimationTime: kvLookup('refreshAnimationTime', config, dataset, 1000),
  ...
  if (obj.config.donut === true) {
    ...
    // value
    valueFontSize = ((widgetH / 8.5) > obj.config.valueMinFontSize) ? (widgetH / 8.5) : obj.config.valueMinFontSize;
    valueX = dx + widgetW / 2;
